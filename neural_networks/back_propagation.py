...
def bp_training(samples: pd.DataFrame, labels: pd.DataFrame, learning_rate: float, stop_function: Callable[[DataSet, SingleHidenLayerNM]], bool) -> SingleHidenLayerNM:
    ...
    while True:
        ...
        for index, sample in samples.iterrows():
            ...
            labeled_values = labels.iloc[index] # 标记值
        ...
        # 8. end for
    # 9. until 达到停止条件
        if stop_function(trainning_set, nm):
            break